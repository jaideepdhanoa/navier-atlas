...
ECON_SLIDE = {
    ...
    "corridor": "Hato Airport -> Baoase Luxury Resort, leeward coast near Willemstad",
...
MARKET_SLIDES = {
    4: {
        ...
        "title": "Curaçao — your resort coast, connected by water",
        "subtitle": "Calm leeward routes linking arrivals, the cruise pier and your resorts — ready today.",
    },
    5: {
        ...
        "title": "Curaçao — the complete island network",
        "subtitle": "Connecting arrivals, the historic Willemstad waterfront and every resort on the coast.",
    },
    6: {
        ...
        "title": "The wider vision — Curaçao, Bonaire & Aruba",
        "subtitle": "Future island-to-island routes, opening as Navier's range grows.",
    },
}
...
def slide10_tam_map() -> dict[str, str]:
    ...
    return {
        ...
        "som_caption": f"Today — Navier fares on the resort coast, serving 45% of current trips (${som_m:.0f}M)",
        "sam_value": t["sam_mid_display"],
        "sam_caption": f"Near term — faster, quieter boats grow the market, up to 90% of trips at maturity (${sam_m:.0f}M)",
        "tam_value": t["tam_marine_mid_display"],
        "tam_caption": f"Full market — the entire premium sea-transfer demand this unlocks (${tam_m:.0f}M)",
        "journey_gmv_value": t["tam_journey_gmv_mid_display"],
        "journey_gmv_caption": f"Whole journey — add dining, stays and experiences to every crossing (${jgmv_m:.0f}M)",
        "platform_value": "",
        "platform_caption": "",
    }
...
def build_narrative(partner: dict) -> dict[tuple[str, str], str]:
    ...
    narrative: dict[tuple[str, str], str] = {
        ...
        (SLIDE3_OID, "g3eec5122801_0_4"): "Curaçao — extending the journey to the water",
        (
            SLIDE3_OID,
            "g3eec5122801_0_14",
        ): "Revenue grows with each phase — and all of it is yours, with no platform fees.",
