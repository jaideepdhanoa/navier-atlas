...
## 2026-07-01 — PTA category replication (batch 4): San Francisco Bay Ferry (WETA) · Brisbane CityCat · Venice ACTV/AVM · İstanbul Şehir Hatları

Rolled the Bahrain MOTC gold pattern through four more public ferry authorities spanning North America, Oceania, and Europe/Eurasia — same de-jargon, domestic-first arc, public-value economics, sourced boarding points, and hand-waypointed zero-land-crossing Grok routing handoffs. All four are BP-rich, so each dossier carries the full published terminal/pier/wharf list.

**Sourced master-plan grounding (boarding points to the real network):**
- **San Francisco Bay Ferry (WETA)** — the operating terminal network (San Francisco Ferry Building, Pier 41/Fisherman's Wharf, Oakland Jack London Square, Alameda Main St + Seaplane Lagoon, South San Francisco, Richmond, Vallejo) plus the published expansion landings (Mission Bay, Berkeley, Redwood City, Treasure Island, Antioch, Hercules, Martinez); WETA Rapid Electric Emission Free (REEF) battery program + *Sea Change* hydrogen pilot; fleet electrification toward zero-emission. BPs sealed against published terminals.
- **Brisbane CityCat / CityHopper (Brisbane City Council · Translink)** — the full Brisbane River terminal chain (Northshore Hamilton, Apollo Road, Bretts Wharf, New Farm Park, Sydney Street, Mowbray Park, Holman Street, Thornton Street, Riverside, Eagle Street Pier, QUT Gardens Point, South Bank 1–3, Maritime Museum, Thornton St, North Quay, Regatta, Guyatt Park, West End, UQ St Lucia, etc.); committed all-electric CityCat fleet. **New geography** — see seed-node note below.
- **Venice ACTV / AVM (vaporetto)** — the lagoon line network stops (Piazzale Roma, Ferrovia/Santa Lucia, Rialto, San Marco/Vallaresso, Accademia, Zattere, Giudecca/Palanca, San Zaccaria, Arsenale, Fondamente Nove, Murano, Burano, Torcello, Lido Santa Maria Elisabetta, San Servolo, Tronchetto, etc.); ACTV fleet electrification push. Densest waterborne public-transit network on earth; near-zero land-crossing geometry.
- **İstanbul Şehir Hatları (City Lines)** — the Bosphorus + Golden Horn + Princes' Islands pier network (Eminönü, Karaköy, Beşiktaş, Kabataş, Üsküdar, Kadıköy, Beylerbeyi, Çengelköy, Kanlıca, Anadolu Kavağı, Rumeli Kavağı, Sarıyer, Büyükada, Heybeliada, Burgazada, Kınalıada, Eyüp, Haliç stops, etc.); municipal electric-ferry program underway. Straddles two continents.

**Same reshape as batches 2–3:** dropped the Journey-GMV super-app ladder rung, plain operating-revenue + public-value block, plain horizon names, phase rationale/narrative de-jargoned, all featured-routes/journeys built on real terminal/pier/wharf nodes with `route_id: null` + `_link_status: "geometry_seal_pending"`. **Economics are honest-pending** (no finance-model seeds exist for net-new authorities): qualitative public-value levers only; Grok regenerates magnitudes against the sealed network. Cities verified: `san-francisco-bay-area-usa`, `venice-italy`, `istanbul-turkey` resolve; `brisbane-australia` seeded (below). Four Grok routing specs written with partner-specific hazard tables (SF Bay: Central Bay chop, Alcatraz/Angel Island shipping lanes, Carquinez Strait shoaling; Brisbane River: tidal reaches, CityCat wash limits, Story Bridge spans; Venice lagoon: shallow draft channels, *moto ondoso* wash limits, marker-channel navigation; Bosphorus: strong surface current + counter-current, dense commercial traffic separation scheme, Princes' Islands open-water crossing). All strict gates + build green; fidelity PASS journey_bp=0 on all four.

**New geography — Brisbane seed node (for Grok to reconcile/seal):** `brisbane-australia` had no existing map node. Tasklet seeded a `priority_city` anchor in `data-clean/FEATURES_BY_TYPE.json` (region Oceania, anchor ~[153.017, -27.473], `cluster_id: australia`, `coords_source: tasklet/pta-batch4-2026-06-30`, `_seed_node` flag), registered it in the `australia` cluster in `CLUSTERS.json` (`members_present` bumped to 4), and shipped a gold city brief (`data-clean/city_briefs/brisbane-australia.json` + `partner-pitch/` mirror). This keeps the partner view + map build green today; Grok verifies/snaps the anchor, wires nav/region index, seals BPs, and drops the `_seed_node` flag. Detailed in `GROK-SPEC-brisbane-citycat-domestic-routing-2026-06-30.md`.
