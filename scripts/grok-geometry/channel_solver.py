...
HAND_WAYPOINTS: dict[tuple[str, str], list[list[float]]] = {
    ...
    # Yassir Maghreb geometry deepen (2026-07-07)
    ("bp-ce43828929", "bp-e9cfcaf56d"): [[-5.74, 35.815], [-5.60, 35.90]],
    ("bp-ce43828929", "bp-470c8ff7bb"): [[-5.74, 35.815], [-5.55, 35.92]],
    ("bp-f474677a42", "bp-8eb3a85230"): [[-4.14, 35.19], [-4.25, 35.17]],
    ("bp-98d845b6b1", "bp-996024d3e8"): [[2.94, 36.815]],
    ("bp-996024d3e8", "bp-9a382970b3"): [[3.12, 36.785]],
}
