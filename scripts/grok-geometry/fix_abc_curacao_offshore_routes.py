...
from abc_offshore_waypoints import OFFSHORE_PAIRS, build_offshore_coords, manual_waypoints  # noqa: E402
from bucketB_shared import hav_nm  # noqa: E402
...
def main() -> int:
    ...
    for (from_n, to_n) in OFFSHORE_PAIRS:
        ...
        wps = manual_waypoints(from_n, to_n)
        coords = build_offshore_coords(a, b, wps)
        ...
        p["render_smooth"] = False  # Catmull smoothing can chord across tight archipelago arcs
        p["render_no_bundle"] = True
