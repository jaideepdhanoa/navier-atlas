...
| **#115** | Bite 2 ladder cascade (36 partners) | 🟠 OPEN on GitHub | Grok reports 32/36 core-complete + 4 deferred → **close or confirm tail** |
| **#124** | FE-2 POI follow-through | 🟠 OPEN on GitHub | Grok reports core-complete + ~193 referenced-copy tail → **close or confirm tail** |

**State-sync note:** Grok's `GROK-BACKLOG-PENDING.md` marks #115 and #124 as done, but both remain
**open on GitHub**. Please either close them with the handback receipt or list the residual tail
explicitly so Tasklet/Jaideep can see true status. No issue should be "done in the file, open on the board."
