...
`already_covered_no_shrink` is **not total partner baseline coverage**. It only counts rows that were already covered **inside this incremental 80:20 inheritance candidate set**. Existing partner coverage is now reported separately from `partner-global-registry-map.json` so partial/additive source scans cannot make partners such as Yango or Uber look empty.
...
- **country_supported_candidate_rows_total**: 315
- **net_new_partner_market_binds_total**: 211
...
- **multi_partner_candidate_markets_2plus**: 110
...
- **promote_new_display_and_marquee_economics_candidate**: 53
- **promote_new_display_and_economics_corridor_candidate**: 123
- **thin_market_country_supported_route_grounding_candidate**: 35

## Net-new density counts
- **marquee_economics_ready**: 53
- **full_display_geometry_no_economics**: 123
- **thin_brief_only_needs_route_grounding**: 35
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| bolt | 14 | 47 | 86 | 40 | 46 | 11 | 21 | 14 |
| cabify | — | — | 5 | 0 | 5 | 1 | 4 | 0 |
| didi | 7 | 12 | 13 | 11 | 2 | 0 | 1 | 1 |
| freenow | — | — | 30 | 0 | 30 | 8 | 18 | 4 |
| gojek | 6 | 10 | 14 | 10 | 4 | 1 | 3 | 0 |
| grab | 13 | 20 | 33 | 17 | 16 | 7 | 9 | 0 |
| indrive | 4 | 18 | 72 | 13 | 59 | 21 | 30 | 8 |
| kakao-mobility | 4 | 4 | 4 | 4 | 0 | 0 | 0 | 0 |
| lyft | 6 | 11 | 16 | 5 | 11 | 0 | 10 | 1 |
| ola | 4 | 4 | 4 | 4 | 0 | 0 | 0 | 0 |
| uber | 17 | 79 | 28 | 0 | 28 | 2 | 20 | 6 |
| yango | 8 | 18 | 10 | 0 | 10 | 2 | 7 | 1 |

## Focus partner notes

### bolt
- Existing baseline: **14** partner-market rows, **47** unique Atlas registry city IDs.
- Incremental 80:20 candidate set: **86** matches; **40** already-covered within that incremental set; **46** net-new additive binds.
- Net-new by country: Greece (3), Italy (1), Kenya (2), Malaysia (5), Malta (1), Mexico (5), Morocco (4), New Zealand (2), Nigeria (1), Norway (3), Saudi Arabia (2), South Africa (1), Taiwan (2), Tanzania (4), Thailand (3), United Arab Emirates (6), United Kingdom (1).

### grab
- Existing baseline: **13** partner-market rows, **20** unique Atlas registry city IDs.
...
### uber
- Existing baseline: **17** partner-market rows, **79** unique Atlas registry city IDs.
...
### yango
- Existing baseline: **8** partner-market rows, **18** unique Atlas registry city IDs.
- Incremental 80:20 candidate set: **10** matches; **0** already-covered within that incremental set; **10** net-new additive binds.
- Yango note: the prior `0 already covered` headline was only within the new additive seed scopes. It does **not** mean Yango had no baseline; the baseline has 8 market rows and 18 unique Atlas city IDs.
...
| Langkawi (`langkawi-malaysia`) | Malaysia | 3 | 3 | full_to_marquee_candidate | 62 | 3 |
| Lombok (`lombok-indonesia`) | Indonesia | 3 | 2 | full_to_marquee_candidate | 48 | 1 |
| Desaru Coast (Johor) (`desaru-coast-malaysia`) | Malaysia | 3 | 3 | full_to_marquee_candidate | 42 | 1 |
...
| Cancún & the Riviera Maya (`cancun-riviera-maya-mexico`) | Mexico | 3 | 2 | thin_to_full_economics_corridor_candidate | 24 | 0 |
| Geirangerfjord (`geiranger-norway`) | Norway | 3 | 3 | thin_to_full_economics_corridor_candidate | 22 | 0 |
| Puerto Vallarta & Riviera Nayarit (`puerto-vallarta-mexico`) | Mexico | 3 | 2 | thin_to_full_economics_corridor_candidate | 22 | 0 |
| Cape Town (`cape-town-south-africa`) | South Africa | 3 | 2 | thin_to_full_economics_corridor_candidate | 19 | 0 |
| Los Cabos (`los-cabos-mexico`) | Mexico | 3 | 2 | thin_to_full_economics_corridor_candidate | 18 | 0 |
...
| Tioman Island (Tekek) (`tioman-island`) | Malaysia | 3 | 3 | thin_to_full_economics_corridor_candidate | 1 | 0 |
| Cozumel (San Miguel) (`cozumel-mexico`) | Mexico | 3 | 2 | thin_route_grounding_candidate | 0 | 0 |
| Playa del Carmen (`playa-del-carmen-mexico`) | Mexico | 3 | 2 | thin_route_grounding_candidate | 0 | 0 |
| Singapore (`singapore`) | Singapore | 2 | 0 | thin_to_full_economics_corridor_candidate | 280 | 2 |
| Manama (`manama-bahrain`) | Bahrain | 2 | 2 | thin_to_full_economics_corridor_candidate | 105 | 11 |
| Manila (`manila-philippines`) | Philippines | 2 | 2 | thin_to_full_economics_corridor_candidate | 95 | 1 |
| Cebu / Mactan (`cebu-philippines`) | Philippines | 2 | 2 | thin_to_full_economics_corridor_candidate | 94 | 1 |
| Mykonos & the Cyclades (`mykonos-greece`) | Greece | 2 | 1 | thin_to_full_economics_corridor_candidate | 91 | 1 |
| Paros & Antiparos (`paros-greece`) | Greece | 2 | 1 | thin_to_full_economics_corridor_candidate | 87 | 0 |
| Jeddah (`jeddah-ksa`) | Saudi Arabia | 2 | 1 | thin_to_full_economics_corridor_candidate | 86 | 4 |
| Colombo & South Coast Resort Belt (`colombo-sri-lanka`) | Sri Lanka | 2 | 2 | thin_to_full_economics_corridor_candidate | 77 | 0 |
| Red Sea Global (`red-sea-global-ksa`) | Saudi Arabia | 2 | 2 | thin_to_full_economics_corridor_candidate | 74 | 0 |
| Eastern Province (Dammam / Khobar) (`eastern-province-ksa`) | Saudi Arabia | 2 | 1 | thin_to_full_economics_corridor_candidate | 69 | 0 |
| Nicoya Peninsula & Papagayo (`nicoya-papagayo-costa-rica`) | Costa Rica | 2 | 2 | thin_to_full_economics_corridor_candidate | 69 | 0 |
| Santorini & the South Cyclades (`santorini-greece`) | Greece | 2 | 1 | thin_to_full_economics_corridor_candidate | 66 | 0 |
| Boracay / Caticlan (`boracay-philippines`) | Philippines | 2 | 1 | thin_to_full_economics_corridor_candidate | 56 | 1 |
| Agadir & Essaouira Atlantic Coast (`agadir-essaouira-morocco`) | Morocco | 2 | 1 | thin_to_full_economics_corridor_candidate | 52 | 0 |
| Phu Quoc (`phu-quoc-vietnam`) | Vietnam | 2 | 1 | thin_to_full_economics_corridor_candidate | 44 | 1 |
| Rio de Janeiro & Costa Verde (`rio-de-janeiro-brazil`) | Brazil | 2 | 1 | thin_to_full_economics_corridor_candidate | 44 | 0 |
| Côte d'Azur (French Riviera) (`cote-dazur-france`) | France | 2 | 1 | thin_to_full_economics_corridor_candidate | 42 | 1 |
| Yeosu & Tongyeong (Hallyeo) (`yeosu-tongyeong-korea`) | South Korea | 2 | 1 | thin_to_full_economics_corridor_candidate | 41 | 0 |
| Helsinki & the Archipelago (`helsinki-finland`) | Finland | 2 | 1 | thin_to_full_economics_corridor_candidate | 40 | 1 |
| Palawan (El Nido / Coron) (`palawan-philippines`) | Philippines | 2 | 2 | thin_to_full_economics_corridor_candidate | 40 | 0 |
| NEOM (`neom-sindalah-ksa`) | Saudi Arabia | 2 | 2 | thin_to_full_economics_corridor_candidate | 38 | 4 |
...
4. Only after this review, convert `true_gap_scopes_after_inheritance` into the Step 3 shared registry expansion queue.
