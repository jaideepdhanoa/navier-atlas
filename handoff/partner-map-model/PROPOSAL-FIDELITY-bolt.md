...
| journey | — | Split → Hvar | `—` | **KEEP** | — |
| journey | — | Nice Airport → Monaco | `—` | **KEEP** | — |
| journey | — | Dubai Marina Yacht Club (DMYC) → Le Méridien & Wes | `—` | **KEEP** | — |
| journey | market:croatia | Split Riva → Trogir Riva | `—` | **KEEP** | — |
| journey | market:croatia | TP Line | Dubrovnik → Kolocep Harbour | `—` | **KEEP** | — |
| journey | market:croatia | Ferry Port Split → Ferry - Šolta | `—` | **KEEP** | — |
| journey | market:croatia | Dubrovnik → Cavtat | `—` | **KEEP** | — |
...
| journey | market:egypt | El Gouna (internal lagoon) → El Gouna Downtown / A | `—` | **KEEP** | — |
| journey | market:egypt | Cairo - Maadi → Cairo - Zamalek / Downtown | `—` | **KEEP** | — |
| journey | market:egypt | Marina El Gouna → Four Seasons Resort Sharm El She | `—` | **KEEP** | — |
| journey | market:egypt | Marina El Gouna → Four Seasons Resort Sharm El She | `—` | **KEEP** | — |
...
| journey | market:france-riviera | Vieux Port (Cannes) → Port de Saint-Tropez | `—` | **KEEP** | — |
| journey | market:france-riviera | Menton → Monaco | `—` | **KEEP** | — |
| journey | market:france-riviera | Nice Port → Port Hercule (Monaco) | `—` | **KEEP** | — |
| journey | market:france-riviera | Vieux Port (Cannes) → Port de Saint-Tropez | `—` | **KEEP** | — |
| journey | market:greece | Mykonos Old Port → Delos — Delos boat pier (archae | `—` | **KEEP** | — |
| journey | market:greece | 2nd Glyfada Marina → Astir Marina Vouliagmenis | `—` | **KEEP** | — |
| journey | market:greece | Mykonos & the Cyclades → Marina Studios - Naxos, G | `—` | **KEEP** | — |
| journey | market:greece | Marina Zeas (Piraeus) → 2nd Glyfada Marina | `—` | **KEEP** | — |
| journey | market:ireland | Dalkey → Dalkey Island | `—` | **KEEP** | — |
| journey | market:ireland | Howth → Ireland's Eye | `—` | **KEEP** | — |
| journey | market:ireland | Dublin Docklands → Dún Laoghaire | `—` | **KEEP** | — |
| journey | market:ireland | Dublin Docklands (North Wall Quay) → Dún Laoghaire | `—` | **KEEP** | — |
| journey | market:italy | Venice → Lido | `—` | **KEEP** | — |
| journey | market:italy | San Marco → Murano / Burano | `—` | **KEEP** | — |
| journey | market:italy | Yachting Santa Margherita → Molo Beverello (Naples | `—` | **KEEP** | — |
| journey | market:italy | Amalfi → Positano — Spiaggia Grande Pier | `—` | **KEEP** | — |
...
| journey | market:qatar | Lusail Marina → Ritz-Carlton Doha — private marina | `—` | **KEEP** | — |
| journey | market:qatar | Doha Corniche → The Pearl | `—` | **KEEP** | — |
| journey | market:qatar | Al Wakrah (Qatar) → The Pearl-Qatar — Marsa Arabia | `—` | **KEEP** | — |
| journey | market:qatar | Al Shyoukh Terminal (Banana Island shuttle departu | `rn-619269ea6bb1` | **KEEP** | — |
...
| journey | market:spain | Puerto Portals → Puerto de Palma | `—` | **KEEP** | — |
| journey | market:spain | Lloret de Mar → Tossa de Mar | `—` | **KEEP** | — |
| journey | market:spain | Marina Port de Mallorca (Palma) → Marina del Port  | `—` | **KEEP** | — |
| journey | market:sweden | Slussen SL Ferry terminal → Allmänna gränd | `—` | **KEEP** | — |
| journey | market:sweden | Nybrokajen (Stockholm) → Nacka Strand | `—` | **KEEP** | — |
| journey | market:sweden | Stockholm (Stadshuskajen / Klara Malarstrand) → Dr | `—` | **KEEP** | — |
| journey | market:sweden | Klara Mälarstrand → Boda brygga | `—` | **KEEP** | — |
