...
| journey | market:athens-cyclades | E1 Gate Ferry to Kos - Piraeus Port → View Yacht - | `—` | **KEEP** | — |
| journey | market:athens-cyclades | E1 Gate Ferry to Kos - Piraeus Port → Skala Marina | `—` | **KEEP** | — |
| journey | market:athens-cyclades | Mykonos & the Cyclades → Santorini & the South Cyc | `—` | **KEEP** | — |
| journey | market:athens-cyclades | Mykonos New Port (Tourlos) → Naxos Port (Chora) | `—` | **KEEP** | — |
