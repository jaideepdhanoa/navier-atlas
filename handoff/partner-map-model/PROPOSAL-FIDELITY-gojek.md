...
| journey | — | Marina Ancol → Pulau Bidadari / Onrust | `—` | **KEEP** | — |
| journey | — | Riau Islands (Kepulauan Riau) — Batam / Bintan / A | `—` | **KEEP** | — |
| journey | — | Komodo / Labuan Bajo / Flores / Sumba → Pink Beach | `—` | **KEEP** | — |
...
| featured | 2 | Marina Ancol → Thousand Islands inner ring (Bidada | `—` | **KEEP** | — |
| featured | 2 | Marina Ancol → Thousand Islands inner ring (Bidada | `—` | **KEEP** | — |
| featured | 2 | Riau Islands (Kepulauan Riau) — Batam / Bintan / A | `—` | **KEEP** | — |
| featured | 3 | Komodo / Labuan Bajo / Flores / Sumba → Komodo Isl | `—` | **KEEP** | — |
| featured | 3 | Labuan Bajo ↔ Pink Beach / manta points | `—` | **KEEP** | — |
| featured | 3 | Likupang / Manado / Bunaken, North Sulawesi, Indon | `—` | **KEEP** | — |
...
| journey | market:riau-singapore | Riau Islands (Kepulauan Riau) — Batam / Bintan / A | `—` | **KEEP** | — |
| journey | market:riau-singapore | Singapore → Bintan (Bandar Bentan Telani / Lagoi) | `—` | **KEEP** | — |
| journey | market:riau-singapore | Singapore → Riau Islands (Kepulauan Riau) — Batam  | `—` | **KEEP** | — |
| journey | market:riau-singapore | Singapore → Riau Islands (Kepulauan Riau) — Batam  | `—` | **KEEP** | — |
| featured | riau-singapore/p1 | Riau Islands (Kepulauan Riau) — Batam / Bintan / A | `—` | **KEEP** | — |
| featured | riau-singapore/p1 | Singapore → Riau Islands (Kepulauan Riau) — Batam  | `—` | **KEEP** | — |
| featured | riau-singapore/p1 | Singapore → Riau Islands (Kepulauan Riau) — Batam  | `—` | **KEEP** | — |
| featured | riau-singapore/p2 | Singapore → Riau Islands (Kepulauan Riau) — Batam  | `—` | **KEEP** | — |
| featured | riau-singapore/p3 | Riau Islands (Kepulauan Riau) — Batam / Bintan / A | `—` | **KEEP** | — |
| featured | riau-singapore/p3 | Singapore → Riau Islands (Kepulauan Riau) — Batam  | `—` | **KEEP** | — |
| featured | riau-singapore/p3 | Singapore → Riau Islands (Kepulauan Riau) — Batam  | `—` | **KEEP** | — |
...
| journey | market:raja-ampat | Raja Ampat (Waisai) → Wayag / Misool | `—` | **KEEP** | — |
