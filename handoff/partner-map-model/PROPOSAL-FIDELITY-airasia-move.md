...
|---------|-------|----------|-------|-----|-------|
| journey | market:koh_samui_gulf | Raja Ferry Lipa Noi Pier (Koh Samui) → Raja Ferry  | `rn-b8f05990286d` | **KEEP** | — |
| journey | market:koh_samui_gulf | Koh Phangan → Thong Sala Pier (Koh Phangan main) | `rn-ad0e20065535` | **KEEP** | — |
| journey | market:koh_samui_gulf | Koh Phangan → Don Sak Ferry Harbour (Surat Thani m | `—` | **KEEP** | — |
| journey | market:koh_samui_gulf | Koh Phangan → Mae Haad Pier (Koh Tao main) | `rn-dc662fc535f1` | **KEEP** | — |
| journey | market:phuket_andaman | phuket-phang-nga-thailand__phuket → koh-lanta-thai | `—` | **KEEP** | — |
| journey | market:phuket_andaman | Phuket → Krabi (Ao Nang) | `—` | **KEEP** | — |
| journey | market:phuket_andaman | phuket-phang-nga-thailand__phuket → koh-lanta-thai | `—` | **KEEP** | — |
| journey | market:phuket_andaman | phuket-phang-nga-thailand__phuket → koh-lanta-thai | `—` | **KEEP** | — |
| journey | market:bangkok | ICONSIAM Pier (Chao Phraya) → ICONSIAM Pier (Chao  | `—` | **KEEP** | — |
| journey | market:bangkok | Sathorn (Central) Pier → Phra Arthit Pier | `—` | **KEEP** | — |
| journey | market:bangkok | Bangkok (Gulf mouth) → Pattaya (Bali Hai Pier) | `—` | **KEEP** | — |
| journey | market:bangkok | Bali Hai Pier → Na Ban Pier (Koh Larn) | `rn-9a98728155ba` | **KEEP** | — |
| journey | market:eastern_seaboard | Bangkok (Gulf mouth) → Pattaya (Bali Hai Pier) | `—` | **KEEP** | — |
| journey | market:eastern_seaboard | Bali Hai Pier → Na Ban Pier (Koh Larn) | `rn-9a98728155ba` | **KEEP** | — |
| journey | market:eastern_seaboard | Ocean Marina Yacht Club (Na Jomtien) → Paradee Res | `rn-24299bbfd9c8` | **KEEP** | — |
| journey | market:eastern_seaboard | Ocean Marina Yacht Club (Na Jomtien) → Paradee Res | `rn-24299bbfd9c8` | **KEEP** | — |
...
| journey | market:bali-nusa-gili | Bali / Nusa Penida / Lembongan / Gilis / Lombok /  | `—` | **KEEP** | — |
| journey | market:bali-nusa-gili | Bali Marina (Benoa) → Six Senses Uluwatu | `—` | **KEEP** | — |
| journey | market:bali-nusa-gili | Sampalan Harbour (Nusa Penida E) → Maruti Port - N | `—` | **KEEP** | — |
...
| journey | market:komodo-flores | Komodo / Labuan Bajo / Flores / Sumba → Pink Beach | `rn-cc1e8cf834c5` | **KEEP** | — |
...
| journey | market:kota-kinabalu | Kota Kinabalu (Jesselton Point) → Gaya Island Reso | `—` | **KEEP** | — |
| journey | market:kota-kinabalu | Sabah / Kota Kinabalu → Manukan Island | `—` | **KEEP** | — |
| journey | market:kota-kinabalu | Kota Kinabalu (Jesselton Point) → Mamutik / Sulug  | `—` | **KEEP** | — |
| journey | market:kota-kinabalu | Semporna Jetty (Sipadan gateway) → Sipadan Island  | `—` | **KEEP** | — |
| journey | market:langkawi | Kuah Jetty Point Complex → Kilim Karst Geoforest P | `—` | **KEEP** | — |
...
| journey | market:penang | George Town (Raja Tun Uda terminal) → Butterworth  | `—` | **KEEP** | — |
...
| journey | market:desaru | Desaru Coast resort jetties → Desaru intra-coast ( | `—` | **KEEP** | — |
...
| journey | market:cebu | Cebu-Mactan Ferry Terminal → Malapascua Island (Lo | `rn-c3336ac6b5a7` | **KEEP** | — |
...
| journey | market:palawan | Coron town → Coron Bay islands (Busuanga resorts) | `rn-b604a03f6078` | **KEEP** | — |
| journey | market:palawan | El Nido Town / Corong-Corong bangka landings → Min | `rn-10169cc46537` | **KEEP** | — |
