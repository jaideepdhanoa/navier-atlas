...
| featured | 1 | Dubai Marina Yacht Club (DMYC) → Le Méridien & Wes | `gcn-0ca7f3ffe7-careem` | **KEEP** | — |
...
| featured | 2 | Nice Port → Port Hercule (Monaco) | `rn-c0f2e69be06c` | **KEEP** | — |
| featured | 2 | Dubai Harbour Marina → Anantara World Islands Reso | `gcn-6a2841d6db-careem` | **KEEP** | — |
