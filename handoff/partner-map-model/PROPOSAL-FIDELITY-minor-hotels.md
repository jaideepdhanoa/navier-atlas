...
| journey | market:maldives | Soneva Fushi (Kunfunadhoo, Baa) → Anantara Kihavah | `—` | **KEEP** | — |
| featured | maldives/p1 | Kudahuvadhoo Airport, Dhaalu ↔ Niyama Private Isla | `—` | **KEEP** | — |
| featured | maldives/p1 | Maafaru Airport, Noonu ↔ Anantara Dhigu Maldives R | `—` | **KEEP** | — |
| featured | maldives/p1 | Dharavandhoo Airport, Baa ↔ Anantara Kihavah Maldi | `—` | **KEEP** | — |
| featured | maldives/p2 | Soneva Fushi (Kunfunadhoo, Baa) ↔ Anantara Kihavah | `—` | **KEEP** | — |
| featured | maldives/p2 | Velana Seaplane ↔ Anantara Veli Maldives Resort | `—` | **KEEP** | — |
| featured | maldives/p3 | Kudahuvadhoo Airport, Dhaalu ↔ Niyama Private Isla | `—` | **KEEP** | — |
| featured | maldives/p3 | Maafaru Airport, Noonu ↔ Anantara Dhigu Maldives R | `—` | **KEEP** | — |
| featured | maldives/p3 | Dharavandhoo Airport, Baa ↔ Anantara Kihavah Maldi | `—` | **KEEP** | — |
| journey | market:thailand_gulf | Anantara Koh Yao Yai Resort & Villas → Avani Samui | `—` | **KEEP** | — |
...
| featured | australia_coastal/p3 | Gold Coast → Gold Coast | `—` | **KEEP** | — |
| featured | mozambique/p1 | Anantara Bazaruto Island Resort — airport → resort | `—` | **KEEP** | — |
| featured | mozambique/p2 | Anantara Medjumbe Island Resort — airport → resort | `—` | **KEEP** | — |
| featured | mozambique/p3 | Avani Pemba Beach Hotel — city → resort/island-hop | `—` | **KEEP** | — |
| featured | vietnam_coastal/p1 | Anantara Hoi An Resort — river/airport → resort | `—` | **KEEP** | — |
| featured | vietnam_coastal/p2 | Anantara Hoi An Resort — river/airport → resort | `—` | **KEEP** | — |
| featured | vietnam_coastal/p3 | Anantara Mui Ne Resort — city → resort | `—` | **KEEP** | — |
| featured | sri_lanka/p1 | Anantara Kalutara Resort — city → SW-coast resort  | `—` | **KEEP** | — |
| featured | sri_lanka/p2 | Avani Kalutara Resort — city → SW-coast resort (~4 | `—` | **KEEP** | — |
| featured | sri_lanka/p3 | Anantara Kalutara Resort — city → SW-coast resort  | `—` | **KEEP** | — |
| featured | americas_coastal/p1 | Tivoli Ecoresort Praia Do Forte Bahia — city → res | `—` | **KEEP** | — |
| featured | americas_coastal/p2 | Anantara Miami Resort & Residences — marina/city → | `—` | **KEEP** | — |
| featured | americas_coastal/p3 | Anantara Mamucabo Bahia Resort — city → resort | `—` | **KEEP** | — |
