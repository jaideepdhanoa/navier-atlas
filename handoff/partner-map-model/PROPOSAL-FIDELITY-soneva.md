...
| featured | 3 | Extend the standard to Soneva Kiri — silent marine | `—` | **KEEP** | — |
| journey | market:maldives | Velana International (Malé) → Soneva Fushi (Baa At | `—` | **KEEP** | — |
| journey | market:maldives | Velana International (Malé) → Soneva Jani (Noonu A | `—` | **KEEP** | — |
| journey | market:maldives | Soneva Fushi → Soneva Jani | `—` | **KEEP** | — |
| journey | market:maldives | Soneva Fushi → Baa Atoll dive & sandbank sites | `—` | **KEEP** | — |
| featured | maldives/p1 | Velana International (Malé) ↔ Soneva Fushi (Baa At | `—` | **KEEP** | — |
| featured | maldives/p1 | Velana International (Malé) ↔ Soneva Jani (Noonu A | `—` | **KEEP** | — |
| featured | maldives/p1 | Soneva Fushi ↔ Soneva Jani | `—` | **KEEP** | — |
| featured | maldives/p2 | Soneva Fushi ↔ Baa Atoll dive & sandbank sites | `—` | **KEEP** | — |
