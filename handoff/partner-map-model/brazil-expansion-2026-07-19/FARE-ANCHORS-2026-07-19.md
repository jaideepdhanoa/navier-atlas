...
| 4 | **Santos–Guarujá** (incl. Vicente de Carvalho and marina/cruise spurs) | **$10** | Uber published average Guarujá→Santos road detour (~45 km) R$49 = US$9.66 — the trip a direct water transfer replaces. Free 2026 pedestrian balsa noted: positioning is speed/comfort/marina, not fare-versus-balsa. Context ceiling: São Paulo→Santos ride-hail US$42.98 (cruise transfers). |
