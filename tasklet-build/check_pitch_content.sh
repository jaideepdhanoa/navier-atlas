...
PAT='Sampriti|Bhattacharyya|Jaideep|Dhanoa|Founders Fund|Builders VC|Series [A-C]|finder|equity/month|go/no-go|milestone fee|\bboard\b|\binvestor|\bwedge\b|\bexclusive\b|\bexclusivity\b|counterparty|HubSpot|internal_only|hold_flag|gate_flag'
