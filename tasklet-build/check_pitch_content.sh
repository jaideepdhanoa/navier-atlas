...
PAT='Sampriti|Bhattacharyya|Jaideep|Dhanoa|Founders Fund|Builders VC|Series B|finder|equity/month|go/no-go|milestone fee|board|investor|wedge|exclusive|counterparty|HubSpot|internal_only|hold_flag|gate_flag'
